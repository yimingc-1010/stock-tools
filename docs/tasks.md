...
| ST-002 | Remove launch-directory dependency from default data paths | Planned | High | Unassigned | `feat/main-structure` | Follow up on the review finding in `core/config.py` |
